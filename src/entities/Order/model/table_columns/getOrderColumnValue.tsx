...
import { dateToTimeString } from "~/shared/lib";
...
export const getOrderColumnValue = (
  ...
  switch (key) {
    ...
    case "best_offer_company":
      return order?.offers?.[0]?.transporter_manager.company.company_name;
    case "transporter":
      if (role === "transporter")
    ...
    case "offer_price":
      const priceData = order.price_data;
      return priceData && "price" in priceData ? priceData.price : null;
    case "stages_cnt":
